...
<h3 id="the-whitelist" tabindex="-1"><a class="header-anchor" href="#the-whitelist" aria-hidden="true">#</a> The Whitelist</h3>
<p>Join NIA official group（may open review in special time, need to fill out the simple questionnaire ）. Then, send the message according to <strong>the group introduction</strong> to add into whitelist.</p>
<h3 id="join-game" tabindex="-1"><a class="header-anchor" href="#join-game" aria-hidden="true">#</a> Join Game!</h3>
<p>Enter the IP address and server port from group introduction. NOW YOU CAN PLAY.</p>
<h3 id="some-solutions-of-problems" tabindex="-1"><a class="header-anchor" href="#some-solutions-of-problems" aria-hidden="true">#</a> Some Solutions of Problems</h3>
<ul>
<li>Join server by using mobile nerwork(traffic), shows no internet connection.</li>
</ul>
<p>sol：Open “use mobile online game” switch in setting.</p>
<ul>
